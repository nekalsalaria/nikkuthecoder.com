...
const questions = [
    {
        id: 1, difficulty: "Easy", tag: "Loops",
        question: "What is the time complexity of this code?",
        code: `for (int i = 0; i < n; i++) {\n  cout << i;\n}`,
        options: ["O(1)", "O(log n)", "O(n)", "O(n²)"],
        answer: "O(n)",
        explanation: "A single loop from 0 to n runs exactly n times — linear growth.",
    },
    {
        id: 2, difficulty: "Easy", tag: "Loops",
        question: "What is the time complexity?",
        code: `int sum = 0;\nsum = a + b;\nreturn sum;`,
        options: ["O(n)", "O(1)", "O(log n)", "O(n²)"],
        answer: "O(1)",
        explanation: "No loops or recursion — always executes a fixed number of steps regardless of input.",
    },
    {
        id: 3, difficulty: "Easy", tag: "Nested Loops",
        question: "Find the complexity of the nested loop:",
        code: `for (int i = 0; i < n; i++) {\n  for (int j = 0; j < n; j++) {\n    cout << i << " " << j;\n  }\n}`,
        options: ["O(n)", "O(n log n)", "O(n²)", "O(2n)"],
        answer: "O(n²)",
        explanation: "Two nested loops, each running n times → n × n = n² total iterations.",
    },
    {
        id: 4, difficulty: "Medium", tag: "Loops",
        question: "What is the complexity?",
        code: `for (int i = 0; i < n; i++) {\n  for (int j = i; j < n; j++) {\n    process(i, j);\n  }\n}`,
        options: ["O(n)", "O(n²)", "O(n log n)", "O(n³)"],
        answer: "O(n²)",
        explanation: "Although j starts from i (not 0), total iterations = n(n+1)/2 ≈ O(n²).",
    },
    {
        id: 5, difficulty: "Hard", tag: "Nested Loops",
        question: "Three nested loops — what's the complexity?",
        code: `for (int i = 0; i < n; i++)\n  for (int j = 0; j < n; j++)\n    for (int k = 0; k < n; k++)\n      cout << i+j+k;`,
        options: ["O(n²)", "O(3n)", "O(n³)", "O(n log n)"],
        answer: "O(n³)",
        explanation: "Three nested loops each of size n → n × n × n = n³ operations.",
    },
    {
        id: 6, difficulty: "Medium", tag: "Loops",
        question: "What is the complexity?",
        code: `for (int i = 1; i < n; i *= 2) {\n  cout << i;\n}`,
        options: ["O(n)", "O(n²)", "O(log n)", "O(1)"],
        answer: "O(log n)",
        explanation: "i doubles each iteration. It takes log₂(n) doublings to reach n.",
    },
    {
        id: 7, difficulty: "Medium", tag: "Loops",
        question: "What is the time complexity?",
        code: `for (int i = 0; i < n; i++) {\n  for (int j = 0; j < 100; j++) {\n    cout << i << " " << j;\n  }\n}`,
        options: ["O(n²)", "O(100n)", "O(n)", "O(n log n)"],
        answer: "O(n)",
        explanation: "The inner loop runs a fixed 100 times — that's a constant. So overall it's O(100n) = O(n).",
    },
    {
        id: 8, difficulty: "Easy", tag: "Loops",
        question: "What is the complexity of this loop?",
        code: `for (int i = 1; i <= n; i += 2) {\n  cout << i;\n}`,
        options: ["O(n)", "O(n/2)", "O(log n)", "O(1)"],
        answer: "O(n)",
        explanation: "Incrementing by 2 runs n/2 times, which is still O(n) — constants don't matter.",
    },
    {
        id: 9, difficulty: "Easy", tag: "Loops",
        question: "What is the complexity?",
        code: `for (int i = 0; i < n; i++) {\n  for (int j = 0; j < m; j++) {\n    cout << i << " " << j;\n  }\n}`,
        options: ["O(n + m)", "O(n × m)", "O(max(n,m))", "O(log(n+m))"],
        answer: "O(n × m)",
        explanation: "Outer loop runs n times, inner runs m times → total is n × m iterations.",
    },
    {
        id: 10, difficulty: "Medium", tag: "Loops",
        question: "What is the complexity of this loop?",
        code: `for (int i = 0; i < n; i++) {\n  for (int j = 1; j < n; j *= 2) {\n    cout << i << " " << j;\n  }\n}`,
        options: ["O(n²)", "O(n log n)", "O(log n)", "O(n)"],
        answer: "O(n log n)",
        explanation: "Outer loop runs n times. Inner loop doubles j → runs log n times. Total: n × log n.",
    },
    {
        id: 11, difficulty: "Medium", tag: "Loops",
        question: "What is the complexity?",
        code: `for (int i = n; i > 0; i--) {\n  cout << i;\n}`,
        options: ["O(1)", "O(log n)", "O(n)", "O(n²)"],
        answer: "O(n)",
        explanation: "Loop decrements from n to 0, running n times — linear complexity.",
    },
    {
        id: 12, difficulty: "Hard", tag: "Nested Loops",
        question: "What is the complexity?",
        code: `for (int i = 0; i < n; i++) {\n  for (int j = 0; j < i; j++) {\n    cout << i << " " << j;\n  }\n}`,
        options: ["O(n)", "O(n log n)", "O(n²)", "O(n³)"],
        answer: "O(n²)",
        explanation: "Inner loop runs 0 + 1 + 2 + ... + n times = n(n+1)/2 ≈ O(n²).",
    },
    {
        id: 13, difficulty: "Easy", tag: "Loops",
        question: "What is the complexity?",
        code: `for (int i = 0; i < n; i++) {\n  for (int j = 0; j < 5; j++) {\n    sum += arr[i][j];\n  }\n}`,
        options: ["O(n)", "O(5n)", "O(n²)", "O(1)"],
        answer: "O(n)",
        explanation: "Inner loop is constant (5 iterations) — O(n × 5) = O(n).",
    },
    {
        id: 14, difficulty: "Medium", tag: "Loops",
        question: "What is the complexity of this nested loop?",
        code: `for (int i = 0; i < n; i++) {\n  for (int j = i; j < n; j++) {\n    for (int k = 0; k < m; k++) {\n      process();\n    }\n  }\n}`,
        options: ["O(n × m)", "O(n² × m)", "O(n³)", "O(n log n)"],
        answer: "O(n² × m)",
        explanation: "First two loops give O(n²), third adds O(m) → O(n² × m) total.",
    },
    {
        id: 15, difficulty: "Hard", tag: "Nested Loops",
        question: "What is the complexity?",
        code: `for (int i = 1; i <= n; i *= 2) {\n  for (int j = 0; j < i; j++) {\n    cout << j;\n  }\n}`,
        options: ["O(n)", "O(n log n)", "O(n²)", "O(log² n)"],
        answer: "O(n)",
        explanation: "Outer loop runs log n times. Inner runs 1+2+4+...+n = O(n) total → O(n).",
    },
    {
        id: 16, difficulty: "Easy", tag: "Loops",
        question: "What is the complexity?",
        code: `for (int i = 0; i < n; i++) {\n  cout << i;\n  i += 10;\n}`,
        options: ["O(1)", "O(n/10)", "O(n)", "O(log n)"],
        answer: "O(n)",
        explanation: "Incrementing by 10 reduces iterations to n/10, still O(n) — constants ignored.",
    },
    {
        id: 17, difficulty: "Medium", tag: "Loops",
        question: "What is the complexity?",
        code: `for (int i = 0; i < n; i++) {\n  for (int j = n; j > i; j--) {\n    sum += arr[i][j];\n  }\n}`,
        options: ["O(n)", "O(n log n)", "O(n²)", "O(n³)"],
        answer: "O(n²)",
        explanation: "Outer runs n times, inner runs from n down to i → total = n + (n-1) + ... = O(n²).",
    },
    {
        id: 18, difficulty: "Easy", tag: "Loops",
        question: "What is the complexity?",
        code: `int count = 0;\nwhile (count < n) {\n  count++;\n  cout << count;\n}`,
        options: ["O(1)", "O(log n)", "O(n)", "O(n²)"],
        answer: "O(n)",
        explanation: "While loop increments count n times — runs n iterations, O(n) complexity.",
    },
    {
        id: 19, difficulty: "Hard", tag: "Nested Loops",
        question: "What is the complexity?",
        code: `for (int i = 0; i < n; i++) {\n  for (int j = 0; j < n; j += i + 1) {\n    cout << i << " " << j;\n  }\n}`,
        options: ["O(n)", "O(n log n)", "O(n²)", "O(n³)"],
        answer: "O(n log n)",
        explanation: "Outer loop n times, inner loop steps increase (1, 1/2, 1/3...) → O(n log n) total.",
    },
    {
        id: 20, difficulty: "Medium", tag: "Loops",
        question: "What is the complexity?",
        code: `for (int i = n; i > 0; i /= 2) {\n  for (int j = 0; j < i; j++) {\n    cout << i << " " << j;\n  }\n}`,
        options: ["O(n)", "O(n log n)", "O(log² n)", "O(n²)"],
        answer: "O(n)",
        explanation: "Outer loop halves i (log n times). Inner runs n + n/2 + n/4 + ... ≈ O(2n) = O(n).",
    },
];
...
const tagColor = { Loops: "#3b82f6", "Nested Loops": "#8b5cf6", Sorting: "#ec4899", Search: "#06b6d4", Recursion: "#f97316", Arrays: "#10b981", HashMap: "#14b8a6" };

export default function TCPractice() {
    ...
    if (finished) {
        ...
        const grade = pct >= 85 ? { label: "Excellent!", color: "#10b981", msg: "You've mastered Time Complexity!" } : pct >= 60 ? { label: "Good Job!", color: "#f59e0b", msg: "Review a few tricky ones and you'll nail it." } : { label: "Keep Practicing", color: "#ef4444", msg: "Go back to the learn page and revisit the concepts." };
        return (
    ...
    return (
        <div style={{ minHeight: "100vh", background: "#080d18", color: "#e2e8f0", fontFamily: "'Sora', sans-serif" }}>
            ...
            <div style={{ background: "rgba(8,13,24,0.95)", borderBottom: "1px solid rgba(255,255,255,0.06)", padding: "14px 20px", display: "flex", alignItems: "center", gap: "12px", position: "sticky", top: 0, zIndex: 30, backdropFilter: "blur(12px)" }}>
                ...
                <div style={{ flex: 1 }}>
                    <div style={{ fontSize: "15px", fontWeight: "700" }}>TC Practice</div>
